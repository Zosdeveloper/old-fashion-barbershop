...
export const GALLERY_ITEMS = [
  ...
  { id: "cuts-06", src: "/images/gallery/cuts-06.jpg", alt: "Textured crop with mid fade side profile", category: "Cuts" as const },
  { id: "cuts-07", src: "/images/gallery/cuts-07.jpg", alt: "Classic taper with slicked back finish", category: "Cuts" as const },
  { id: "cuts-08", src: "/images/gallery/cuts-08.jpg", alt: "Clean fade with swept back top", category: "Cuts" as const },
  { id: "cuts-09", src: "/images/gallery/cuts-09.jpg", alt: "Textured fringe with long layers", category: "Cuts" as const },
  { id: "cuts-10", src: "/images/gallery/cuts-10.jpg", alt: "Platinum blonde fade with textured top", category: "Cuts" as const },
  { id: "cuts-11", src: "/images/gallery/cuts-11.jpg", alt: "Low fade with wavy pompadour and lined beard", category: "Cuts" as const },
  { id: "cuts-12", src: "/images/gallery/cuts-12.jpg", alt: "Classic side part with slick finish", category: "Cuts" as const },
  { id: "cuts-13", src: "/images/gallery/cuts-13.jpg", alt: "Blonde textured crop from behind", category: "Cuts" as const },
  { id: "cuts-14", src: "/images/gallery/cuts-14.jpg", alt: "Sleek slicked back medium length cut", category: "Cuts" as const },
  { id: "cuts-15", src: "/images/gallery/cuts-15.jpg", alt: "Pompadour fade with curled forelock detail", category: "Cuts" as const },
  { id: "cuts-16", src: "/images/gallery/cuts-16.jpg", alt: "Mid fade with textured crop side profile", category: "Cuts" as const },
  { id: "cuts-17", src: "/images/gallery/cuts-17.jpg", alt: "Low fade with wavy textured top and beard", category: "Cuts" as const },
  { id: "cuts-18", src: "/images/gallery/cuts-18.jpg", alt: "Slicked back undercut with full beard", category: "Cuts" as const },
  { id: "cuts-19", src: "/images/gallery/cuts-19.jpg", alt: "Curly top undercut with skin fade", category: "Cuts" as const },
  { id: "cuts-20", src: "/images/gallery/cuts-20.jpg", alt: "Bald head with shaped red beard", category: "Cuts" as const },
  { id: "cuts-21", src: "/images/gallery/cuts-21.jpg", alt: "Sharp high fade with hard part", category: "Cuts" as const },
